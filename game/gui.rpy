...
define -2 gui.hover_sound = "mod_assets/audio/sfx/hover.wav" # Hover Sound Effect
define -2 gui.activate_sound = "mod_assets/audio/sfx/select.wav" # Click Sound Effect
