...
init python:
    ...
    splash_messages = [
        "This game is an unofficial fan game that is unaffiliated with Team Salvato.",
        "Mother was wrong. Wait, who is mother?",
        "Monika is watching you!",
        "I'm not a masochist, I'm just crazy."
    ]
...
image menu_bg:
    topleft
    "gui/menu_bg.png"
    recolorize("gui/menu_bg.png", "#00c100", "#ecf8f8", 1.29)
    #menu_bg_move

image team_splash:
    topleft
    "mod_assets/images/UI/team_splash.png"
    xcenter 800
    ycenter 400
    zoom 0.50
...
image game_menu_bg:
    topleft
    "gui/menu_bg.png"
    recolorize("gui/menu_bg.png", "#00c100", "#fff", 1.29)
    menu_bg_loop
...
image menu_nav:
    "mod_assets/images/UI/menu_background.png"
...
# This image stores the Team Salvato logo image that appears when the game starts.
image intro:
    truecenter
    "white"
    0.5
...
label splashscreen:
    ...
    $ splash_message = random.choice(splash_messages)
...
## This label sets the main menu music before the
## menu starts.
