...
#My addition
image bg living_room_day = "../mod_assets/background/mc_living_room_background/day.png"
image bg living_room_night = "../mod_assets/background/mc_living_room_background/night.png"
...
define uk = DynamicCharacter('uk_name', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define mc = DynamicCharacter('player', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(2, "#000", 0, 0), (1, "#000", 1, 1)])
define s = DynamicCharacter('s_name', image='sayori', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(2, "#9b91fa", 0, 0), (1, "#9b91fa", 1, 1)])
define m = DynamicCharacter('m_name', image='monika', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(2, "#00c100", 0, 0), (1, "#00c100", 1, 1)])
define n = DynamicCharacter('n_name', image='natsuki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(2, "#fc9797", 0, 0), (1, "#fc9797", 1, 1)])
define y = DynamicCharacter('y_name', image='yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed", who_outlines=[(2, "#0003b3", 0, 0), (1, "#0003b3", 1, 1)])
