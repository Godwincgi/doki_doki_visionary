...
init 1 python:
    ...
    author_mc = Author("mc", music=audio.tsayori)
...
Not all good times must come to an end."""))
    ...
    poem_mc1 = Poem(
        author_mc, title =_("Blanket"),
        text =_("""\
The cold wind rubs against my skin
As I stand alone in a dark, lifeless scene
A presence joins me with a grin
Something warm, something green.\n

Is it here to help, or is it here to harm?
"It doesn't matter" I conclude
It tells me to remain calm
Suddenly I feel loved, I feel valued.\n

I basked in this unfamiliar presence until my heart was content
But it wasn't enough, I was still alone
I wandered far without consent
In search of company by the endzone.\n

Like moth drawn to the flame, they each came to me
Colors of light - blue, pink and purple
Same as precious stones, I collected all three
In my hands, I held them - nice and gentle.\n

In a flash, the world around me loses its warmth
The cold air returning as my blanket fades
I watch as the light in my hands burn with wrath
Ripping away a piece of me like sharp blades.\n

Although I felt pain, I was unable to cry or scream
I floated in anguish until my blanket returned 
Enveloping me once more it would seem
Despite its warmth, I was imprisoned.\n

To be here is to be in solitude
To not be here is to choose agony
"I am all you need" it continued
I smiled, even if it was a fallacy,\n


I was protected from the cold dark world."""))
