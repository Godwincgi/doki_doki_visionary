...
define -2 text_outline_color = "#000"
...
style frame:
    ...
    background Frame("mod_assets/images/UI/frame_new.png", gui.frame_borders, tile=gui.frame_tile)
...
style window:
    ...
    background Transform("mod_assets/images/UI/textbox_new.png", xalign=0.5, yalign=1.0)
...
style namebox:
    ...
    background Frame("mod_assets/images/UI/namebox_new.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
        ...
        for i in items:
            ...
            if "kwargs=" in i.caption:
                ...
                if "#" in kwarg:
                    ...
                    textbutton caption:
                        idle_background Frame(im.MatrixColor(im.MatrixColor("mod_assets/images/UI/choice_idle_background_new.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#00f", "#fff") * im.matrix.saturation(120)), 
                            im.matrix.desaturate() * im.matrix.colorize(arg1, arg2)), gui.choice_button_borders)
                        hover_background Frame(im.MatrixColor(im.MatrixColor("mod_assets/images/UI/choice_hover_background_new.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#00f", "#fff") * im.matrix.saturation(120)), 
...
style choice_button is default:
    ...
    idle_background Frame("mod_assets/images/UI/choice_idle_background_new.png", gui.choice_button_borders)
    hover_background Frame("mod_assets/images/UI/choice_hover_background_new.png", gui.choice_button_borders)
...
style quick_button_text:
    ...
    hover_outlines [(0.5, "#888", 0, 0), (0.5, "#888", 0, 0)]
    selected_color "#f00"
    outlines []
...
style navigation_button_text:
    ...
    color "#fff"
    hover_outlines [(2, text_outline_color, 0, 0), (1, text_outline_color, 2, 2)]
    insensitive_outlines [(2, "#f00", 0, 0), (1, "#f00", 2, 2)]
...
style game_menu_outer_frame:
    ...
    background "mod_assets/images/UI/menu_background.png"
...
screen about():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                add Transform("mod_assets//DDV_logo.png", size=(200,200)) xalign .5
...
style slot_button:
    ...
    idle_background Frame("mod_assets/images/UI/slot_idle_background_new.png", gui.choice_button_borders)
    hover_background Frame("mod_assets/images/UI/slot_hover_background_new.png", gui.choice_button_borders)
...
style confirm_frame:
    background Frame("mod_assets/images/UI/frame_new.png", gui.confirm_frame_borders, tile=gui.frame_tile)
